...
echo ""
echo "\" Define a function that calls NERDTreeFind after every cd"
echo "function! CdAndFindTree(dir)"
echo "  execute 'NERDTree'"
echo "  execute 'cd ' . a:dir"
echo "  execute 'NERDTreeFind'"
echo "endfunction"
echo ""
echo "\" Create a command that overrides the standard cd command"
echo "command! -nargs=1 CD call CdAndFindTree(<q-args>)"
echo ""
